...
def run_mask_emails(text: str) -> tuple[str, int]:
    from cs336_data.filtering_cc.pii.mask import mask_emails
    return mask_emails(text)


def run_mask_phone_numbers(text: str) -> tuple[str, int]:
    from cs336_data.filtering_cc.pii.mask import mask_phone_numbers
    return mask_phone_numbers(text)


def run_mask_ips(text: str) -> tuple[str, int]:
    from cs336_data.filtering_cc.pii.mask import mask_ips
...
def run_classify_toxic_speech(text: str) -> tuple[Any, float]:
    from cs336_data.filtering_cc.harmful_content.classify import classify_toxic_speech
...
def run_exact_line_deduplication(
    ...
    from cs336_data.deduplication.exact_line.exact_line import exact_line_deduplication
...
def run_minhash_deduplication(
    ...
    from cs336_data.deduplication.minhash.minhash import minhash_deduplication
